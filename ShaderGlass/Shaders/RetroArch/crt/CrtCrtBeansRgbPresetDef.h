/*
ShaderGlass preset crt / crt-beans-rgb imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/a4f3aeec04fcb2624ec6df5dd17e38f9b575eab9/crt/crt-beans-rgb.slangp
...
namespace RetroArch
{
class CrtCrtBeansRgbPresetDef : public PresetDef
{
public:
	CrtCrtBeansRgbPresetDef() : PresetDef{}
	{
		Name = "crt-beans-rgb";
		Category = "crt";
	}
