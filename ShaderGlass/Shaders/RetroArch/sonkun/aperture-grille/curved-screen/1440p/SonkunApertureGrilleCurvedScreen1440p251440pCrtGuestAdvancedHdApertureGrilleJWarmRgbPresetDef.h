/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 25-1440p-crt-guest-advanced-hd-aperture-grille-j-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "25-1440p-crt-guest-advanced-hd-aperture-grille-j-warm-rgb";
