/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 01-1440p-crt-guest-advanced-hd-aperture-grille-u-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "01-1440p-crt-guest-advanced-hd-aperture-grille-u-normal-rf";
