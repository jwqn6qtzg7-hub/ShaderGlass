/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 37-1440p-crt-guest-advanced-hd-aperture-grille-pal-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "37-1440p-crt-guest-advanced-hd-aperture-grille-pal-warm-composite";
