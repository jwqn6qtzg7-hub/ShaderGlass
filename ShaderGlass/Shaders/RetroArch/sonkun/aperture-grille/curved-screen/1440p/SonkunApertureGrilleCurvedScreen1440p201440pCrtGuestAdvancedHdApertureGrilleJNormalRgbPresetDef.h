/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 20-1440p-crt-guest-advanced-hd-aperture-grille-j-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "20-1440p-crt-guest-advanced-hd-aperture-grille-j-normal-rgb";
