/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 41-1440p-crt-guest-advanced-hd-aperture-grille-pal-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "41-1440p-crt-guest-advanced-hd-aperture-grille-pal-cool-rf";
