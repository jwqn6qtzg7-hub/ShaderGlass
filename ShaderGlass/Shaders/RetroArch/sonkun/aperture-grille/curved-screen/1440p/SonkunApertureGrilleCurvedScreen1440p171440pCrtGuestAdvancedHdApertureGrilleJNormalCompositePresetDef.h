/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 17-1440p-crt-guest-advanced-hd-aperture-grille-j-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "17-1440p-crt-guest-advanced-hd-aperture-grille-j-normal-composite";
