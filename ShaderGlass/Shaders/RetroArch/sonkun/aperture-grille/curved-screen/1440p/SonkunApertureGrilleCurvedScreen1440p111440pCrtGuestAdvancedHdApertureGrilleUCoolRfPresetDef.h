/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 11-1440p-crt-guest-advanced-hd-aperture-grille-u-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "11-1440p-crt-guest-advanced-hd-aperture-grille-u-cool-rf";
