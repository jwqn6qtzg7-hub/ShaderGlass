/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 06-1440p-crt-guest-advanced-hd-aperture-grille-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-1440p-crt-guest-advanced-hd-aperture-grille-u-warm-rf";
