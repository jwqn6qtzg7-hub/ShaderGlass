/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 16-1440p-crt-guest-advanced-hd-aperture-grille-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-1440p-crt-guest-advanced-hd-aperture-grille-j-normal-rf";
