/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 22-1440p-crt-guest-advanced-hd-aperture-grille-j-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "22-1440p-crt-guest-advanced-hd-aperture-grille-j-warm-composite";
