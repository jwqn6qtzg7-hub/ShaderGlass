/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 21-1440p-crt-guest-advanced-hd-aperture-grille-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-1440p-crt-guest-advanced-hd-aperture-grille-j-warm-rf";
