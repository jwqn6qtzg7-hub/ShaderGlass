/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1440p / 31-1440p-crt-guest-advanced-hd-aperture-grille-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-1440p-crt-guest-advanced-hd-aperture-grille-pal-normal-rf";
