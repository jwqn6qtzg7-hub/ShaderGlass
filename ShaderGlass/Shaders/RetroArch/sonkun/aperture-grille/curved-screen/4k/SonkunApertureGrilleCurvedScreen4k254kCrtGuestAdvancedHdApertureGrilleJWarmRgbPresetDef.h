/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 25-4k-crt-guest-advanced-hd-aperture-grille-j-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "25-4k-crt-guest-advanced-hd-aperture-grille-j-warm-rgb";
