/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 02-4k-crt-guest-advanced-hd-aperture-grille-u-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "02-4k-crt-guest-advanced-hd-aperture-grille-u-normal-composite";
