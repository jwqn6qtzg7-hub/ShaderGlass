/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 41-4k-crt-guest-advanced-hd-aperture-grille-pal-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "41-4k-crt-guest-advanced-hd-aperture-grille-pal-cool-rf";
