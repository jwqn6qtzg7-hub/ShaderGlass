/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 20-4k-crt-guest-advanced-hd-aperture-grille-j-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "20-4k-crt-guest-advanced-hd-aperture-grille-j-normal-rgb";
