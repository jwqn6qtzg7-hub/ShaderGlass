/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 16-4k-crt-guest-advanced-hd-aperture-grille-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-4k-crt-guest-advanced-hd-aperture-grille-j-normal-rf";
