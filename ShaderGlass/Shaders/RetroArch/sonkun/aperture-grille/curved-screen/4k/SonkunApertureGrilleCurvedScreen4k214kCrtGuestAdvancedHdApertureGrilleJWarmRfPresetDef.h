/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 21-4k-crt-guest-advanced-hd-aperture-grille-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-4k-crt-guest-advanced-hd-aperture-grille-j-warm-rf";
