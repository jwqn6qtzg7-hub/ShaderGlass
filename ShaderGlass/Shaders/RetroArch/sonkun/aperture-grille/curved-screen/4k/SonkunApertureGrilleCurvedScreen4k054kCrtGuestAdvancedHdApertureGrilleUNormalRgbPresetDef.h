/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 05-4k-crt-guest-advanced-hd-aperture-grille-u-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "05-4k-crt-guest-advanced-hd-aperture-grille-u-normal-rgb";
