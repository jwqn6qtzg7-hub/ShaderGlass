/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 26-4k-crt-guest-advanced-hd-aperture-grille-j-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "26-4k-crt-guest-advanced-hd-aperture-grille-j-cool-rf";
