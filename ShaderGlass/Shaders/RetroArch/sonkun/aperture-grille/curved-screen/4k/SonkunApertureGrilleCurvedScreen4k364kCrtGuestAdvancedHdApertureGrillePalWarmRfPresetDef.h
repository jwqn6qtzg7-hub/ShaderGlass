/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 36-4k-crt-guest-advanced-hd-aperture-grille-pal-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "36-4k-crt-guest-advanced-hd-aperture-grille-pal-warm-rf";
