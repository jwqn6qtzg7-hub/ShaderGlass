/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 27-4k-crt-guest-advanced-hd-aperture-grille-j-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "27-4k-crt-guest-advanced-hd-aperture-grille-j-cool-composite";
