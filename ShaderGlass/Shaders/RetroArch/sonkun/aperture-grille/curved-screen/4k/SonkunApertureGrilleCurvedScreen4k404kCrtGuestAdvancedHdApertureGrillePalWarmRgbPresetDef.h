/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 40-4k-crt-guest-advanced-hd-aperture-grille-pal-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "40-4k-crt-guest-advanced-hd-aperture-grille-pal-warm-rgb";
