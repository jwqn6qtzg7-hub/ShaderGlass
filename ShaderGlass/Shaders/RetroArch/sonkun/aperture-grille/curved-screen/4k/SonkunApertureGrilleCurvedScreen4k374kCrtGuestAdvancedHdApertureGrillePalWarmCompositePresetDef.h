/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 37-4k-crt-guest-advanced-hd-aperture-grille-pal-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "37-4k-crt-guest-advanced-hd-aperture-grille-pal-warm-composite";
