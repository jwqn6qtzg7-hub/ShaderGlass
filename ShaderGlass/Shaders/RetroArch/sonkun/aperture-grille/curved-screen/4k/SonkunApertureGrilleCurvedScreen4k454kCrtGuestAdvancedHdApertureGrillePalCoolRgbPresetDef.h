/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 45-4k-crt-guest-advanced-hd-aperture-grille-pal-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "45-4k-crt-guest-advanced-hd-aperture-grille-pal-cool-rgb";
