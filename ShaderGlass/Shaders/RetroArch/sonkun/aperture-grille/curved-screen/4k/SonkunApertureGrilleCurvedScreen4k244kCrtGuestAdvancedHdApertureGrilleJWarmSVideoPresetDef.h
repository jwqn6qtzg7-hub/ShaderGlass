/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 24-4k-crt-guest-advanced-hd-aperture-grille-j-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "24-4k-crt-guest-advanced-hd-aperture-grille-j-warm-s-video";
