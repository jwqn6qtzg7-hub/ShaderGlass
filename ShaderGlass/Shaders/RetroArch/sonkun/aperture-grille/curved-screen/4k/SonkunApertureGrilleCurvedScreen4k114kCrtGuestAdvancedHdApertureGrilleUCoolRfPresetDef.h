/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 11-4k-crt-guest-advanced-hd-aperture-grille-u-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "11-4k-crt-guest-advanced-hd-aperture-grille-u-cool-rf";
