/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 42-4k-crt-guest-advanced-hd-aperture-grille-pal-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "42-4k-crt-guest-advanced-hd-aperture-grille-pal-cool-composite";
