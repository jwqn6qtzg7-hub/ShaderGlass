/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 35-4k-crt-guest-advanced-hd-aperture-grille-pal-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "35-4k-crt-guest-advanced-hd-aperture-grille-pal-normal-rgb";
