/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 30-4k-crt-guest-advanced-hd-aperture-grille-j-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "30-4k-crt-guest-advanced-hd-aperture-grille-j-cool-rgb";
