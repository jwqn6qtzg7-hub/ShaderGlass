/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 31-4k-crt-guest-advanced-hd-aperture-grille-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-4k-crt-guest-advanced-hd-aperture-grille-pal-normal-rf";
