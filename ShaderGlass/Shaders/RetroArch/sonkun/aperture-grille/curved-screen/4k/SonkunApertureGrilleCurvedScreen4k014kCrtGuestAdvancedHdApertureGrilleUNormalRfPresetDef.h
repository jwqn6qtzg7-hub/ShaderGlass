/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 01-4k-crt-guest-advanced-hd-aperture-grille-u-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "01-4k-crt-guest-advanced-hd-aperture-grille-u-normal-rf";
