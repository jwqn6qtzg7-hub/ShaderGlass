/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 06-4k-crt-guest-advanced-hd-aperture-grille-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-4k-crt-guest-advanced-hd-aperture-grille-u-warm-rf";
