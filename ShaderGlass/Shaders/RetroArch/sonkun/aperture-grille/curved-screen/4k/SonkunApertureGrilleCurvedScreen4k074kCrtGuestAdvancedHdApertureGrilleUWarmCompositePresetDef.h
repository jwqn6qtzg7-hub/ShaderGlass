/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 07-4k-crt-guest-advanced-hd-aperture-grille-u-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "07-4k-crt-guest-advanced-hd-aperture-grille-u-warm-composite";
