/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/4k / 10-4k-crt-guest-advanced-hd-aperture-grille-u-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "10-4k-crt-guest-advanced-hd-aperture-grille-u-warm-rgb";
