/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 30-1080p-crt-guest-advanced-hd-aperture-grille-j-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "30-1080p-crt-guest-advanced-hd-aperture-grille-j-cool-rgb";
