/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 26-1080p-crt-guest-advanced-hd-aperture-grille-j-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "26-1080p-crt-guest-advanced-hd-aperture-grille-j-cool-rf";
