/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 36-1080p-crt-guest-advanced-hd-aperture-grille-pal-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "36-1080p-crt-guest-advanced-hd-aperture-grille-pal-warm-rf";
