/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 17-1080p-crt-guest-advanced-hd-aperture-grille-j-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "17-1080p-crt-guest-advanced-hd-aperture-grille-j-normal-composite";
