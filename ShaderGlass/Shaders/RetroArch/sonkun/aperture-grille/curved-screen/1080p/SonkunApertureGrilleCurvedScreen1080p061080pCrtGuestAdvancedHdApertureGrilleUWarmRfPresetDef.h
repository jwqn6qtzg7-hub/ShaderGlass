/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 06-1080p-crt-guest-advanced-hd-aperture-grille-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-1080p-crt-guest-advanced-hd-aperture-grille-u-warm-rf";
