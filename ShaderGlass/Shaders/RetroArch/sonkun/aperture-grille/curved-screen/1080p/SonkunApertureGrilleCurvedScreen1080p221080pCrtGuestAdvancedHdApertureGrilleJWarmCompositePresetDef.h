/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 22-1080p-crt-guest-advanced-hd-aperture-grille-j-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "22-1080p-crt-guest-advanced-hd-aperture-grille-j-warm-composite";
