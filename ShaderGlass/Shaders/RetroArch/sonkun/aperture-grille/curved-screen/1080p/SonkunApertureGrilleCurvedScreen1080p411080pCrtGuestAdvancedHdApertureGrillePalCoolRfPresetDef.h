/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 41-1080p-crt-guest-advanced-hd-aperture-grille-pal-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "41-1080p-crt-guest-advanced-hd-aperture-grille-pal-cool-rf";
