/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 21-1080p-crt-guest-advanced-hd-aperture-grille-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-1080p-crt-guest-advanced-hd-aperture-grille-j-warm-rf";
