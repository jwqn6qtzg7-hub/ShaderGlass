/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 11-1080p-crt-guest-advanced-hd-aperture-grille-u-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "11-1080p-crt-guest-advanced-hd-aperture-grille-u-cool-rf";
