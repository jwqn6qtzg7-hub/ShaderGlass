/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 40-1080p-crt-guest-advanced-hd-aperture-grille-pal-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "40-1080p-crt-guest-advanced-hd-aperture-grille-pal-warm-rgb";
