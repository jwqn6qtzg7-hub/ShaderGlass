/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 31-1080p-crt-guest-advanced-hd-aperture-grille-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-1080p-crt-guest-advanced-hd-aperture-grille-pal-normal-rf";
