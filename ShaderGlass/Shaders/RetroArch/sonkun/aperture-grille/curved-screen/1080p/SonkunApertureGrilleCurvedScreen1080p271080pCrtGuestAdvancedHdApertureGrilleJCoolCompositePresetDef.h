/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 27-1080p-crt-guest-advanced-hd-aperture-grille-j-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "27-1080p-crt-guest-advanced-hd-aperture-grille-j-cool-composite";
