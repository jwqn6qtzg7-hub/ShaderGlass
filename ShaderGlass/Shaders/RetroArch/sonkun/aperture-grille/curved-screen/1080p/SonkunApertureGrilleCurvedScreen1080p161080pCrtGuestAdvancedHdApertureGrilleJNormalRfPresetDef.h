/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 16-1080p-crt-guest-advanced-hd-aperture-grille-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-1080p-crt-guest-advanced-hd-aperture-grille-j-normal-rf";
