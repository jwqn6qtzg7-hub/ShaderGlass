/*
ShaderGlass preset sonkun/aperture-grille/curved-screen/1080p / 20-1080p-crt-guest-advanced-hd-aperture-grille-j-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "20-1080p-crt-guest-advanced-hd-aperture-grille-j-normal-rgb";
