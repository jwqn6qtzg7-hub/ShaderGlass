/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 26-4k-crt-guest-advanced-hd-shadow-mask-j-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "26-4k-crt-guest-advanced-hd-shadow-mask-j-cool-rf";
