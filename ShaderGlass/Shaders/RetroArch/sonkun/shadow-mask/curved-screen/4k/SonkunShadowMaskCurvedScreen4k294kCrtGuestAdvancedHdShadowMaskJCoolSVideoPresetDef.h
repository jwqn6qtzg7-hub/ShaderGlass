/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 29-4k-crt-guest-advanced-hd-shadow-mask-j-cool-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "29-4k-crt-guest-advanced-hd-shadow-mask-j-cool-s-video";
