/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 16-4k-crt-guest-advanced-hd-shadow-mask-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-4k-crt-guest-advanced-hd-shadow-mask-j-normal-rf";
