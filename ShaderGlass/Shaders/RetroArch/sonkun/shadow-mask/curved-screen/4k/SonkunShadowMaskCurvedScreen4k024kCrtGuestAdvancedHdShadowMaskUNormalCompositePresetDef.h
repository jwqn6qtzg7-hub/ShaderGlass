/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 02-4k-crt-guest-advanced-hd-shadow-mask-u-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "02-4k-crt-guest-advanced-hd-shadow-mask-u-normal-composite";
