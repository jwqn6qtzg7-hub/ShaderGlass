/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 10-4k-crt-guest-advanced-hd-shadow-mask-u-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "10-4k-crt-guest-advanced-hd-shadow-mask-u-warm-rgb";
