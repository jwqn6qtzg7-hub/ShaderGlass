/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 25-4k-crt-guest-advanced-hd-shadow-mask-j-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "25-4k-crt-guest-advanced-hd-shadow-mask-j-warm-rgb";
