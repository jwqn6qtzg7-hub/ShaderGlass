/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 01-4k-crt-guest-advanced-hd-shadow-mask-u-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "01-4k-crt-guest-advanced-hd-shadow-mask-u-normal-rf";
