/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 35-4k-crt-guest-advanced-hd-shadow-mask-pal-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "35-4k-crt-guest-advanced-hd-shadow-mask-pal-normal-rgb";
