/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 37-4k-crt-guest-advanced-hd-shadow-mask-pal-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "37-4k-crt-guest-advanced-hd-shadow-mask-pal-warm-composite";
