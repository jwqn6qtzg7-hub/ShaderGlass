/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 17-4k-crt-guest-advanced-hd-shadow-mask-j-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "17-4k-crt-guest-advanced-hd-shadow-mask-j-normal-composite";
