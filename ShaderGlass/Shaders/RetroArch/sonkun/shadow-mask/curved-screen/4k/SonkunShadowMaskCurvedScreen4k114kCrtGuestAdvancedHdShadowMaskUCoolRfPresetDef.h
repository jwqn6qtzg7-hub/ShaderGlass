/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 11-4k-crt-guest-advanced-hd-shadow-mask-u-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "11-4k-crt-guest-advanced-hd-shadow-mask-u-cool-rf";
