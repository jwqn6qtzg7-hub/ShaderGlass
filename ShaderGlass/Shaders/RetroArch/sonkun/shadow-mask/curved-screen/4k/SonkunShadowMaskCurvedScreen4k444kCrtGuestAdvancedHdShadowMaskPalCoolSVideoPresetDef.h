/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 44-4k-crt-guest-advanced-hd-shadow-mask-pal-cool-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "44-4k-crt-guest-advanced-hd-shadow-mask-pal-cool-s-video";
