/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 32-4k-crt-guest-advanced-hd-shadow-mask-pal-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "32-4k-crt-guest-advanced-hd-shadow-mask-pal-normal-composite";
