/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 39-4k-crt-guest-advanced-hd-shadow-mask-pal-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "39-4k-crt-guest-advanced-hd-shadow-mask-pal-warm-s-video";
