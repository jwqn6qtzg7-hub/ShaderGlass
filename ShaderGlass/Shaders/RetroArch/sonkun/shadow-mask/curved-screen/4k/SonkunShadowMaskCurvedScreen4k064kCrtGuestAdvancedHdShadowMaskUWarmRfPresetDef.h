/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 06-4k-crt-guest-advanced-hd-shadow-mask-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-4k-crt-guest-advanced-hd-shadow-mask-u-warm-rf";
