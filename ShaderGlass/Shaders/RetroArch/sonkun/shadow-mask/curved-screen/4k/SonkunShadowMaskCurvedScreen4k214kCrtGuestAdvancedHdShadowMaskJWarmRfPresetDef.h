/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/4k / 21-4k-crt-guest-advanced-hd-shadow-mask-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-4k-crt-guest-advanced-hd-shadow-mask-j-warm-rf";
