/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 02-1440p-crt-guest-advanced-hd-shadow-mask-u-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "02-1440p-crt-guest-advanced-hd-shadow-mask-u-normal-composite";
