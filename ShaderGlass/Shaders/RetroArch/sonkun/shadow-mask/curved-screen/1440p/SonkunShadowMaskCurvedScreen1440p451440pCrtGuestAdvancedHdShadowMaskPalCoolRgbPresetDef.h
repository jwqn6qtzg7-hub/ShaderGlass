/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 45-1440p-crt-guest-advanced-hd-shadow-mask-pal-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "45-1440p-crt-guest-advanced-hd-shadow-mask-pal-cool-rgb";
