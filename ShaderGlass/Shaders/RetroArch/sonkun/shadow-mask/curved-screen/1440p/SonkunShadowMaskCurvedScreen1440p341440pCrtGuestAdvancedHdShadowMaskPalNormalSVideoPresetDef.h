/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 34-1440p-crt-guest-advanced-hd-shadow-mask-pal-normal-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "34-1440p-crt-guest-advanced-hd-shadow-mask-pal-normal-s-video";
