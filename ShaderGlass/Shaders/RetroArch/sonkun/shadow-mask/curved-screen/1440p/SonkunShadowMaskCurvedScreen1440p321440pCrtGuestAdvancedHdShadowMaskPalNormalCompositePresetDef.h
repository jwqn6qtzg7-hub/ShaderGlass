/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 32-1440p-crt-guest-advanced-hd-shadow-mask-pal-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "32-1440p-crt-guest-advanced-hd-shadow-mask-pal-normal-composite";
