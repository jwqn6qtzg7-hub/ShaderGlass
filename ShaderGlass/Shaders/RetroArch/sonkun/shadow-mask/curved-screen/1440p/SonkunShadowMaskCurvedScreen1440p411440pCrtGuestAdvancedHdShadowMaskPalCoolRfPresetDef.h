/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 41-1440p-crt-guest-advanced-hd-shadow-mask-pal-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "41-1440p-crt-guest-advanced-hd-shadow-mask-pal-cool-rf";
