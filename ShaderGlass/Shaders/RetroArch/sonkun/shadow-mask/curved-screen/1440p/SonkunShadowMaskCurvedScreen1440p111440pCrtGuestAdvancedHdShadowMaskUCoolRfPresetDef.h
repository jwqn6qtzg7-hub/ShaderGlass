/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 11-1440p-crt-guest-advanced-hd-shadow-mask-u-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "11-1440p-crt-guest-advanced-hd-shadow-mask-u-cool-rf";
