/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 25-1440p-crt-guest-advanced-hd-shadow-mask-j-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "25-1440p-crt-guest-advanced-hd-shadow-mask-j-warm-rgb";
