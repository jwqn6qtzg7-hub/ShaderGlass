/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 26-1440p-crt-guest-advanced-hd-shadow-mask-j-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "26-1440p-crt-guest-advanced-hd-shadow-mask-j-cool-rf";
