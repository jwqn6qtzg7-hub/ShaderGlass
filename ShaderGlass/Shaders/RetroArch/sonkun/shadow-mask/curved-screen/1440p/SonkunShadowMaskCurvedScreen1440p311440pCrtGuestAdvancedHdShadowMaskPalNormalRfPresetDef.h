/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 31-1440p-crt-guest-advanced-hd-shadow-mask-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-1440p-crt-guest-advanced-hd-shadow-mask-pal-normal-rf";
