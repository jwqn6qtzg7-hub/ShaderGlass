/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 20-1440p-crt-guest-advanced-hd-shadow-mask-j-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "20-1440p-crt-guest-advanced-hd-shadow-mask-j-normal-rgb";
