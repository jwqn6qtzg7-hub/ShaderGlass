/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 39-1440p-crt-guest-advanced-hd-shadow-mask-pal-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "39-1440p-crt-guest-advanced-hd-shadow-mask-pal-warm-s-video";
