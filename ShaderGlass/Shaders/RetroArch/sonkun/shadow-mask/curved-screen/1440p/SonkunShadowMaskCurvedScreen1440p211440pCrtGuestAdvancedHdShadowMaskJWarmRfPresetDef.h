/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 21-1440p-crt-guest-advanced-hd-shadow-mask-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-1440p-crt-guest-advanced-hd-shadow-mask-j-warm-rf";
