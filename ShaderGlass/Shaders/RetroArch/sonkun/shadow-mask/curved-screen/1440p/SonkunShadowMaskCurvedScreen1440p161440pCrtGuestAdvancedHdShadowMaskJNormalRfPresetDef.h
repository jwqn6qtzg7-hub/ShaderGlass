/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1440p / 16-1440p-crt-guest-advanced-hd-shadow-mask-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-1440p-crt-guest-advanced-hd-shadow-mask-j-normal-rf";
