/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 19-1080p-crt-guest-advanced-hd-shadow-mask-j-normal-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "19-1080p-crt-guest-advanced-hd-shadow-mask-j-normal-s-video";
