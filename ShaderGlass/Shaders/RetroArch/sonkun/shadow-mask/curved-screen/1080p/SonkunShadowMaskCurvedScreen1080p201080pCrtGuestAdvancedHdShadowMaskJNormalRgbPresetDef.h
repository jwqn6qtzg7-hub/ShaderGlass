/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 20-1080p-crt-guest-advanced-hd-shadow-mask-j-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "20-1080p-crt-guest-advanced-hd-shadow-mask-j-normal-rgb";
