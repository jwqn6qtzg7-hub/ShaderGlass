/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 44-1080p-crt-guest-advanced-hd-shadow-mask-pal-cool-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "44-1080p-crt-guest-advanced-hd-shadow-mask-pal-cool-s-video";
