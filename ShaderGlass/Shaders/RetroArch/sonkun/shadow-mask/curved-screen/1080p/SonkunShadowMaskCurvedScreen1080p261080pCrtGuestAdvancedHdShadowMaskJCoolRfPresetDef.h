/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 26-1080p-crt-guest-advanced-hd-shadow-mask-j-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "26-1080p-crt-guest-advanced-hd-shadow-mask-j-cool-rf";
