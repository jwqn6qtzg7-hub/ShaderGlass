/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 06-1080p-crt-guest-advanced-hd-shadow-mask-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-1080p-crt-guest-advanced-hd-shadow-mask-u-warm-rf";
