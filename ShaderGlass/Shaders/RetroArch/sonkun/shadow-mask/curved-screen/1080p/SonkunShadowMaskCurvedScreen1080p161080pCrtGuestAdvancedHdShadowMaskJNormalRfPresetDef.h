/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 16-1080p-crt-guest-advanced-hd-shadow-mask-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-1080p-crt-guest-advanced-hd-shadow-mask-j-normal-rf";
