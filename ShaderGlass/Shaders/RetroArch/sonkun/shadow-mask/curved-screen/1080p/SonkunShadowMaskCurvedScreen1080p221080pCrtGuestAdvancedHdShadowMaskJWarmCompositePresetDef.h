/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 22-1080p-crt-guest-advanced-hd-shadow-mask-j-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "22-1080p-crt-guest-advanced-hd-shadow-mask-j-warm-composite";
