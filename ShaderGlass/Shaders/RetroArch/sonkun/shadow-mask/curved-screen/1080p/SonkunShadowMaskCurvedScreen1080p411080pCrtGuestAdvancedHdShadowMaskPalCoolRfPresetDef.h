/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 41-1080p-crt-guest-advanced-hd-shadow-mask-pal-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "41-1080p-crt-guest-advanced-hd-shadow-mask-pal-cool-rf";
