/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 31-1080p-crt-guest-advanced-hd-shadow-mask-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-1080p-crt-guest-advanced-hd-shadow-mask-pal-normal-rf";
