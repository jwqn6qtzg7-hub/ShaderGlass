/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 37-1080p-crt-guest-advanced-hd-shadow-mask-pal-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "37-1080p-crt-guest-advanced-hd-shadow-mask-pal-warm-composite";
