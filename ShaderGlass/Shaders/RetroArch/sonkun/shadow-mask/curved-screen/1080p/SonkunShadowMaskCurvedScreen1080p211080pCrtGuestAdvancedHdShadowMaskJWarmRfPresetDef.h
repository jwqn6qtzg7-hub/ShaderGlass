/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 21-1080p-crt-guest-advanced-hd-shadow-mask-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-1080p-crt-guest-advanced-hd-shadow-mask-j-warm-rf";
