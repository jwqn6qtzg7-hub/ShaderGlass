/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 01-1080p-crt-guest-advanced-hd-shadow-mask-u-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "01-1080p-crt-guest-advanced-hd-shadow-mask-u-normal-rf";
