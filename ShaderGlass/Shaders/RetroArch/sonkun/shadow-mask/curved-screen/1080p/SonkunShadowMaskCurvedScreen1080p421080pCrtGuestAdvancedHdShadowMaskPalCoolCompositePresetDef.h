/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 42-1080p-crt-guest-advanced-hd-shadow-mask-pal-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "42-1080p-crt-guest-advanced-hd-shadow-mask-pal-cool-composite";
