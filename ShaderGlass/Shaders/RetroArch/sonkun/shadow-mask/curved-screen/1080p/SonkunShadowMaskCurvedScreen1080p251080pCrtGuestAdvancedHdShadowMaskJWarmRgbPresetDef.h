/*
ShaderGlass preset sonkun/shadow-mask/curved-screen/1080p / 25-1080p-crt-guest-advanced-hd-shadow-mask-j-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "25-1080p-crt-guest-advanced-hd-shadow-mask-j-warm-rgb";
