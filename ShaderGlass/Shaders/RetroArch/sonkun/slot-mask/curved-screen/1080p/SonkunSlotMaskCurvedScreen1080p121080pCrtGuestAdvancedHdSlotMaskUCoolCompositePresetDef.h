/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 12-1080p-crt-guest-advanced-hd-slot-mask-u-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "12-1080p-crt-guest-advanced-hd-slot-mask-u-cool-composite";
