/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 02-1080p-crt-guest-advanced-hd-slot-mask-u-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "02-1080p-crt-guest-advanced-hd-slot-mask-u-normal-composite";
