/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 31-1080p-crt-guest-advanced-hd-slot-mask-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-1080p-crt-guest-advanced-hd-slot-mask-pal-normal-rf";
