/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 40-1080p-crt-guest-advanced-hd-slot-mask-pal-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "40-1080p-crt-guest-advanced-hd-slot-mask-pal-warm-rgb";
