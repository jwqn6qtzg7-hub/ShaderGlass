/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 09-1080p-crt-guest-advanced-hd-slot-mask-u-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "09-1080p-crt-guest-advanced-hd-slot-mask-u-warm-s-video";
