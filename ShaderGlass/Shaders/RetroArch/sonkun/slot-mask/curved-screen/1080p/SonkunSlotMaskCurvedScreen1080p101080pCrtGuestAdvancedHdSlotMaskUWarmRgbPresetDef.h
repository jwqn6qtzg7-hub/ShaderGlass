/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 10-1080p-crt-guest-advanced-hd-slot-mask-u-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "10-1080p-crt-guest-advanced-hd-slot-mask-u-warm-rgb";
