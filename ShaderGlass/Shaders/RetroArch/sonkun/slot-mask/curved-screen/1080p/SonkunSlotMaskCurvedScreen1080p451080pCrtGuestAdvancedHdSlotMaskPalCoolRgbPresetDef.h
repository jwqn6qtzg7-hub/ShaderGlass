/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 45-1080p-crt-guest-advanced-hd-slot-mask-pal-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "45-1080p-crt-guest-advanced-hd-slot-mask-pal-cool-rgb";
