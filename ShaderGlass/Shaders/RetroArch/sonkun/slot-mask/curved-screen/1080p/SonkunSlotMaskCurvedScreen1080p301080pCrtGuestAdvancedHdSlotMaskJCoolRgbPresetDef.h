/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 30-1080p-crt-guest-advanced-hd-slot-mask-j-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "30-1080p-crt-guest-advanced-hd-slot-mask-j-cool-rgb";
