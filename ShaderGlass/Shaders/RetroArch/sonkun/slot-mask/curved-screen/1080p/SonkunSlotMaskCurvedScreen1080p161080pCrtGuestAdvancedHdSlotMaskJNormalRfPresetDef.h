/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 16-1080p-crt-guest-advanced-hd-slot-mask-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-1080p-crt-guest-advanced-hd-slot-mask-j-normal-rf";
