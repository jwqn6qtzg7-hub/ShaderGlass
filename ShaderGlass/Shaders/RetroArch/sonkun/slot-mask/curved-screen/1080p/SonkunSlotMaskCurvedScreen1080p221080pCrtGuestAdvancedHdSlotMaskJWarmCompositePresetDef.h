/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 22-1080p-crt-guest-advanced-hd-slot-mask-j-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "22-1080p-crt-guest-advanced-hd-slot-mask-j-warm-composite";
