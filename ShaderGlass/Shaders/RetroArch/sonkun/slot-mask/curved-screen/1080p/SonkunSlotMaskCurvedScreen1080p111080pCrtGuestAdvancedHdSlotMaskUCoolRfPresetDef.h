/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 11-1080p-crt-guest-advanced-hd-slot-mask-u-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "11-1080p-crt-guest-advanced-hd-slot-mask-u-cool-rf";
