/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 42-1080p-crt-guest-advanced-hd-slot-mask-pal-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "42-1080p-crt-guest-advanced-hd-slot-mask-pal-cool-composite";
