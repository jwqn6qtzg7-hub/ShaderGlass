/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 24-1080p-crt-guest-advanced-hd-slot-mask-j-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "24-1080p-crt-guest-advanced-hd-slot-mask-j-warm-s-video";
