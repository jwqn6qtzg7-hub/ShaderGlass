/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 34-1080p-crt-guest-advanced-hd-slot-mask-pal-normal-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "34-1080p-crt-guest-advanced-hd-slot-mask-pal-normal-s-video";
