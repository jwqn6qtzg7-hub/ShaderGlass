/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 06-1080p-crt-guest-advanced-hd-slot-mask-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-1080p-crt-guest-advanced-hd-slot-mask-u-warm-rf";
