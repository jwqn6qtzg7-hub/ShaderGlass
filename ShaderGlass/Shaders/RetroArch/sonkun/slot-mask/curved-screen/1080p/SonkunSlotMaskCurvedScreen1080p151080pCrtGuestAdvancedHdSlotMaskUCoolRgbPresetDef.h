/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 15-1080p-crt-guest-advanced-hd-slot-mask-u-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "15-1080p-crt-guest-advanced-hd-slot-mask-u-cool-rgb";
