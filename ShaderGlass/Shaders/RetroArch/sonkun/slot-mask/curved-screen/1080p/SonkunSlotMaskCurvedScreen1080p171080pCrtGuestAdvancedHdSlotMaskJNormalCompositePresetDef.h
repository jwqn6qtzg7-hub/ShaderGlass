/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 17-1080p-crt-guest-advanced-hd-slot-mask-j-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "17-1080p-crt-guest-advanced-hd-slot-mask-j-normal-composite";
