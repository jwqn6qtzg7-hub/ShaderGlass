/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 35-1080p-crt-guest-advanced-hd-slot-mask-pal-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "35-1080p-crt-guest-advanced-hd-slot-mask-pal-normal-rgb";
