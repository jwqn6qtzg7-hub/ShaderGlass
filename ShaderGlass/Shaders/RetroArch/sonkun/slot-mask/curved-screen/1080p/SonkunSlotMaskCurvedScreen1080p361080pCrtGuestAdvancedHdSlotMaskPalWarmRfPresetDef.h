/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1080p / 36-1080p-crt-guest-advanced-hd-slot-mask-pal-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "36-1080p-crt-guest-advanced-hd-slot-mask-pal-warm-rf";
