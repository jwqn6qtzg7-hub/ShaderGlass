/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 22-1440p-crt-guest-advanced-hd-slot-mask-j-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "22-1440p-crt-guest-advanced-hd-slot-mask-j-warm-composite";
