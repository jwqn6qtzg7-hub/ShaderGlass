/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 31-1440p-crt-guest-advanced-hd-slot-mask-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-1440p-crt-guest-advanced-hd-slot-mask-pal-normal-rf";
