/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 21-1440p-crt-guest-advanced-hd-slot-mask-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-1440p-crt-guest-advanced-hd-slot-mask-j-warm-rf";
