/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 01-1440p-crt-guest-advanced-hd-slot-mask-u-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "01-1440p-crt-guest-advanced-hd-slot-mask-u-normal-rf";
