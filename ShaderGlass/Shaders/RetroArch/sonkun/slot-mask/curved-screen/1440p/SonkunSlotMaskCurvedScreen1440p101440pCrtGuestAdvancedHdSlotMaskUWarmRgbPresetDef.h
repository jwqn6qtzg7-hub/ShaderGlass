/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 10-1440p-crt-guest-advanced-hd-slot-mask-u-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "10-1440p-crt-guest-advanced-hd-slot-mask-u-warm-rgb";
