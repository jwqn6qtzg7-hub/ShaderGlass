/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 02-1440p-crt-guest-advanced-hd-slot-mask-u-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "02-1440p-crt-guest-advanced-hd-slot-mask-u-normal-composite";
