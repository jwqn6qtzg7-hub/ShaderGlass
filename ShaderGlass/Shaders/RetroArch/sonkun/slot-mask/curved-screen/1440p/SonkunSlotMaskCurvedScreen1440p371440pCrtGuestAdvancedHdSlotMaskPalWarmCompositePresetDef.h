/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 37-1440p-crt-guest-advanced-hd-slot-mask-pal-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "37-1440p-crt-guest-advanced-hd-slot-mask-pal-warm-composite";
