/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 12-1440p-crt-guest-advanced-hd-slot-mask-u-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "12-1440p-crt-guest-advanced-hd-slot-mask-u-cool-composite";
