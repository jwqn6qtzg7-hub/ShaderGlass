/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 42-1440p-crt-guest-advanced-hd-slot-mask-pal-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "42-1440p-crt-guest-advanced-hd-slot-mask-pal-cool-composite";
