/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 06-1440p-crt-guest-advanced-hd-slot-mask-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-1440p-crt-guest-advanced-hd-slot-mask-u-warm-rf";
