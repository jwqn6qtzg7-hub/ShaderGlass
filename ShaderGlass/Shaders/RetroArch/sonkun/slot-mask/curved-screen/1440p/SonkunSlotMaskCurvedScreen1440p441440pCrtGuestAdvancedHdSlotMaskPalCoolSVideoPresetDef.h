/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 44-1440p-crt-guest-advanced-hd-slot-mask-pal-cool-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "44-1440p-crt-guest-advanced-hd-slot-mask-pal-cool-s-video";
