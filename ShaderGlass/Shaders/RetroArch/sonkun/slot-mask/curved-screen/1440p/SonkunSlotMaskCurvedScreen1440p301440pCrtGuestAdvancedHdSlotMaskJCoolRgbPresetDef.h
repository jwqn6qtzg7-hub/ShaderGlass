/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 30-1440p-crt-guest-advanced-hd-slot-mask-j-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "30-1440p-crt-guest-advanced-hd-slot-mask-j-cool-rgb";
