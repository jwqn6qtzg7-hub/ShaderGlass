/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 36-1440p-crt-guest-advanced-hd-slot-mask-pal-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "36-1440p-crt-guest-advanced-hd-slot-mask-pal-warm-rf";
