/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 32-1440p-crt-guest-advanced-hd-slot-mask-pal-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "32-1440p-crt-guest-advanced-hd-slot-mask-pal-normal-composite";
