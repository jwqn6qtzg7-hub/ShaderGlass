/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 05-1440p-crt-guest-advanced-hd-slot-mask-u-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "05-1440p-crt-guest-advanced-hd-slot-mask-u-normal-rgb";
