/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 29-1440p-crt-guest-advanced-hd-slot-mask-j-cool-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "29-1440p-crt-guest-advanced-hd-slot-mask-j-cool-s-video";
