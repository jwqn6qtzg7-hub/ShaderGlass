/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 16-1440p-crt-guest-advanced-hd-slot-mask-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-1440p-crt-guest-advanced-hd-slot-mask-j-normal-rf";
