/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 09-1440p-crt-guest-advanced-hd-slot-mask-u-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "09-1440p-crt-guest-advanced-hd-slot-mask-u-warm-s-video";
