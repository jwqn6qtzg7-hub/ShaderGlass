/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 04-1440p-crt-guest-advanced-hd-slot-mask-u-normal-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "04-1440p-crt-guest-advanced-hd-slot-mask-u-normal-s-video";
