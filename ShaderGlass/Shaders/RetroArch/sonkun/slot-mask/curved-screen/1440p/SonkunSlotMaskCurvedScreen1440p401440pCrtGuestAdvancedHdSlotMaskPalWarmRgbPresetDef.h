/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 40-1440p-crt-guest-advanced-hd-slot-mask-pal-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "40-1440p-crt-guest-advanced-hd-slot-mask-pal-warm-rgb";
