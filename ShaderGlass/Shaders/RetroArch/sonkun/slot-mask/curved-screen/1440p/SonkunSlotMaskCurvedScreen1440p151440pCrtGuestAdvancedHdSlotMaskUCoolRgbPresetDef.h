/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 15-1440p-crt-guest-advanced-hd-slot-mask-u-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "15-1440p-crt-guest-advanced-hd-slot-mask-u-cool-rgb";
