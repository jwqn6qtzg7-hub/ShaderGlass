/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 19-1440p-crt-guest-advanced-hd-slot-mask-j-normal-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "19-1440p-crt-guest-advanced-hd-slot-mask-j-normal-s-video";
