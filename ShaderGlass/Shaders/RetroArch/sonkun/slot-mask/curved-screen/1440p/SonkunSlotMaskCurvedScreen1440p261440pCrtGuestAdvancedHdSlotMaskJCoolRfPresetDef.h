/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 26-1440p-crt-guest-advanced-hd-slot-mask-j-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "26-1440p-crt-guest-advanced-hd-slot-mask-j-cool-rf";
