/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 07-1440p-crt-guest-advanced-hd-slot-mask-u-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "07-1440p-crt-guest-advanced-hd-slot-mask-u-warm-composite";
