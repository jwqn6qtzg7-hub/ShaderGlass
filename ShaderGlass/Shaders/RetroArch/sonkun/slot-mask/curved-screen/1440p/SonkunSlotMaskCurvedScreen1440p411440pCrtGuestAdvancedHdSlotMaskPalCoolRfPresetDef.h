/*
ShaderGlass preset sonkun/slot-mask/curved-screen/1440p / 41-1440p-crt-guest-advanced-hd-slot-mask-pal-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "41-1440p-crt-guest-advanced-hd-slot-mask-pal-cool-rf";
