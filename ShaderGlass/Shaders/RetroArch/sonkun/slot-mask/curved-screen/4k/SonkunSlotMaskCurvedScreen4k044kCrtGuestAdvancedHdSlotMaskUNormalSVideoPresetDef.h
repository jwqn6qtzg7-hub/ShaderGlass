/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 04-4k-crt-guest-advanced-hd-slot-mask-u-normal-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "04-4k-crt-guest-advanced-hd-slot-mask-u-normal-s-video";
