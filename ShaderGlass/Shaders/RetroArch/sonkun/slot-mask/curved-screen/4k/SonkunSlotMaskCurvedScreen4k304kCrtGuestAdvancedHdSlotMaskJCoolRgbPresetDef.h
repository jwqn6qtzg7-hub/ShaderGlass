/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 30-4k-crt-guest-advanced-hd-slot-mask-j-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "30-4k-crt-guest-advanced-hd-slot-mask-j-cool-rgb";
