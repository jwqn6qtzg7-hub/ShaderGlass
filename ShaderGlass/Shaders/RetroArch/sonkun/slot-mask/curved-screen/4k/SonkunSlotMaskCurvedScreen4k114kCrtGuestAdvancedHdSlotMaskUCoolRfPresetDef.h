/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 11-4k-crt-guest-advanced-hd-slot-mask-u-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "11-4k-crt-guest-advanced-hd-slot-mask-u-cool-rf";
