/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 41-4k-crt-guest-advanced-hd-slot-mask-pal-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "41-4k-crt-guest-advanced-hd-slot-mask-pal-cool-rf";
