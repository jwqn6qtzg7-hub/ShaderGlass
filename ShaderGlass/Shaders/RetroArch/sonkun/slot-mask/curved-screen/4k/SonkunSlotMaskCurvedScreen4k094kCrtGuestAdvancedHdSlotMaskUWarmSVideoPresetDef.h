/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 09-4k-crt-guest-advanced-hd-slot-mask-u-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "09-4k-crt-guest-advanced-hd-slot-mask-u-warm-s-video";
