/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 20-4k-crt-guest-advanced-hd-slot-mask-j-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "20-4k-crt-guest-advanced-hd-slot-mask-j-normal-rgb";
