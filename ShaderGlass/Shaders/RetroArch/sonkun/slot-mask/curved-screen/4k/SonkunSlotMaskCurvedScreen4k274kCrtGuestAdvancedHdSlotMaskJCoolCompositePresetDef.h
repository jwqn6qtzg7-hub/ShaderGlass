/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 27-4k-crt-guest-advanced-hd-slot-mask-j-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "27-4k-crt-guest-advanced-hd-slot-mask-j-cool-composite";
