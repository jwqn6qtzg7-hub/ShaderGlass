/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 42-4k-crt-guest-advanced-hd-slot-mask-pal-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "42-4k-crt-guest-advanced-hd-slot-mask-pal-cool-composite";
