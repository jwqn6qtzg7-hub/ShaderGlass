/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 19-4k-crt-guest-advanced-hd-slot-mask-j-normal-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "19-4k-crt-guest-advanced-hd-slot-mask-j-normal-s-video";
