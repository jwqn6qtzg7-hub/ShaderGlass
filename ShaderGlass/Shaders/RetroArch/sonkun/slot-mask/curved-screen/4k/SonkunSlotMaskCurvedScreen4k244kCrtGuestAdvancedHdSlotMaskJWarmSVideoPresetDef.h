/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 24-4k-crt-guest-advanced-hd-slot-mask-j-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "24-4k-crt-guest-advanced-hd-slot-mask-j-warm-s-video";
