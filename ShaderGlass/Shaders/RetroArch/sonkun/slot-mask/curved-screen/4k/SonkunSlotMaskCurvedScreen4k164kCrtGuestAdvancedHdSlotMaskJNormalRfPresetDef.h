/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 16-4k-crt-guest-advanced-hd-slot-mask-j-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "16-4k-crt-guest-advanced-hd-slot-mask-j-normal-rf";
