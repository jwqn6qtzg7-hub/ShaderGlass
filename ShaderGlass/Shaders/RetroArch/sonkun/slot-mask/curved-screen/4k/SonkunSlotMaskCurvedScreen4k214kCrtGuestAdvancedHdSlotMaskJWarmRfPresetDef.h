/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 21-4k-crt-guest-advanced-hd-slot-mask-j-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "21-4k-crt-guest-advanced-hd-slot-mask-j-warm-rf";
