/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 14-4k-crt-guest-advanced-hd-slot-mask-u-cool-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "14-4k-crt-guest-advanced-hd-slot-mask-u-cool-s-video";
