/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 39-4k-crt-guest-advanced-hd-slot-mask-pal-warm-s-video imported from Sonkun:
...
public:
	...
	{
		Name = "39-4k-crt-guest-advanced-hd-slot-mask-pal-warm-s-video";
