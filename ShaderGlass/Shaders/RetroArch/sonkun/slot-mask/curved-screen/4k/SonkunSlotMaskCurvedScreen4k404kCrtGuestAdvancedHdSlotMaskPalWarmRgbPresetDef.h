/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 40-4k-crt-guest-advanced-hd-slot-mask-pal-warm-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "40-4k-crt-guest-advanced-hd-slot-mask-pal-warm-rgb";
