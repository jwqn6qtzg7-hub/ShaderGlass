/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 26-4k-crt-guest-advanced-hd-slot-mask-j-cool-rf imported from Sonkun:
...
public:
	...
	{
		Name = "26-4k-crt-guest-advanced-hd-slot-mask-j-cool-rf";
