/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 45-4k-crt-guest-advanced-hd-slot-mask-pal-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "45-4k-crt-guest-advanced-hd-slot-mask-pal-cool-rgb";
