/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 37-4k-crt-guest-advanced-hd-slot-mask-pal-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "37-4k-crt-guest-advanced-hd-slot-mask-pal-warm-composite";
