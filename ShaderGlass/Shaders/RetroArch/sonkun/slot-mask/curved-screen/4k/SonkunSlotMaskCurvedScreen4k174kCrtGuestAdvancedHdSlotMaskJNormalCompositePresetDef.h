/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 17-4k-crt-guest-advanced-hd-slot-mask-j-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "17-4k-crt-guest-advanced-hd-slot-mask-j-normal-composite";
