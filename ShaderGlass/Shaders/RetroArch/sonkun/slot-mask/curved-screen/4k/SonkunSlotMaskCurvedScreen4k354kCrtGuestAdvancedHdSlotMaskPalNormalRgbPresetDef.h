/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 35-4k-crt-guest-advanced-hd-slot-mask-pal-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "35-4k-crt-guest-advanced-hd-slot-mask-pal-normal-rgb";
