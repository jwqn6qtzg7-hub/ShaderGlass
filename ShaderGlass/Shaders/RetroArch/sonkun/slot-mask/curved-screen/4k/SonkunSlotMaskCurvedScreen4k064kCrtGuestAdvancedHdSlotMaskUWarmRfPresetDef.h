/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 06-4k-crt-guest-advanced-hd-slot-mask-u-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "06-4k-crt-guest-advanced-hd-slot-mask-u-warm-rf";
