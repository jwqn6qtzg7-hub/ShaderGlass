/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 36-4k-crt-guest-advanced-hd-slot-mask-pal-warm-rf imported from Sonkun:
...
public:
	...
	{
		Name = "36-4k-crt-guest-advanced-hd-slot-mask-pal-warm-rf";
