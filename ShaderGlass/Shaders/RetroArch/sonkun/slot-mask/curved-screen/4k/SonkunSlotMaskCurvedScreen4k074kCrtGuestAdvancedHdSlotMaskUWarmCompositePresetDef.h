/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 07-4k-crt-guest-advanced-hd-slot-mask-u-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "07-4k-crt-guest-advanced-hd-slot-mask-u-warm-composite";
