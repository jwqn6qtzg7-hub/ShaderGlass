/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 31-4k-crt-guest-advanced-hd-slot-mask-pal-normal-rf imported from Sonkun:
...
public:
	...
	{
		Name = "31-4k-crt-guest-advanced-hd-slot-mask-pal-normal-rf";
