/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 12-4k-crt-guest-advanced-hd-slot-mask-u-cool-composite imported from Sonkun:
...
public:
	...
	{
		Name = "12-4k-crt-guest-advanced-hd-slot-mask-u-cool-composite";
