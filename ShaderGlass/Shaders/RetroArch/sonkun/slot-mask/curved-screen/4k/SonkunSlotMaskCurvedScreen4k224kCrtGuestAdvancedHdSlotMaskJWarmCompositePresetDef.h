/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 22-4k-crt-guest-advanced-hd-slot-mask-j-warm-composite imported from Sonkun:
...
public:
	...
	{
		Name = "22-4k-crt-guest-advanced-hd-slot-mask-j-warm-composite";
