/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 15-4k-crt-guest-advanced-hd-slot-mask-u-cool-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "15-4k-crt-guest-advanced-hd-slot-mask-u-cool-rgb";
