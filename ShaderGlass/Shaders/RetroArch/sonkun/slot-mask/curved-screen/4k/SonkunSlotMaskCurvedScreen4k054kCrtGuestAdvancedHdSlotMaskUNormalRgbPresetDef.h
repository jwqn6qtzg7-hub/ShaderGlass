/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 05-4k-crt-guest-advanced-hd-slot-mask-u-normal-rgb imported from Sonkun:
...
public:
	...
	{
		Name = "05-4k-crt-guest-advanced-hd-slot-mask-u-normal-rgb";
