/*
ShaderGlass preset sonkun/slot-mask/curved-screen/4k / 32-4k-crt-guest-advanced-hd-slot-mask-pal-normal-composite imported from Sonkun:
...
public:
	...
	{
		Name = "32-4k-crt-guest-advanced-hd-slot-mask-pal-normal-composite";
