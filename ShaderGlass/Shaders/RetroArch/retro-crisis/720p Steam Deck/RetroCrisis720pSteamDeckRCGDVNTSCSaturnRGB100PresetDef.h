/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - Saturn RGB 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCSaturnRGB100PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCSaturnRGB100PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Saturn RGB 100";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("barintensity", (float)-0.020000);
            OverrideParam("barspeed", (float)20.000000);
            OverrideParam("beam_max", (float)1.074995);
            OverrideParam("beam_min", (float)0.600000);
            OverrideParam("contr", (float)0.099999);
            ...
            OverrideParam("ntsc_scale", (float)2.249999);
            ...
            OverrideParam("wp_saturation", (float)1.100000);
	}
};
}
