/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - 2600 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSC2600PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSC2600PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - 2600";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("beam_max", (float)1.199999);
            OverrideParam("beam_min", (float)0.650000);
            OverrideParam("bloom", (float)2.000000);
            OverrideParam("bloom_dist", (float)2.000000);
            OverrideParam("cust_artifacting", (float)2.000000);
            OverrideParam("cust_fringing", (float)1.400003);
            OverrideParam("deconrr", (float)2.000000);
            OverrideParam("deconrry", (float)1.750000);
            OverrideParam("double_slot", (float)3.000000);
            OverrideParam("gsl", (float)2.000000);
            OverrideParam("hmask1", (float)-0.000000);
            OverrideParam("m_glow", (float)2.000000);
            OverrideParam("mask_gamma", (float)1.749999);
            ...
            OverrideParam("scanline2", (float)3.000000);
