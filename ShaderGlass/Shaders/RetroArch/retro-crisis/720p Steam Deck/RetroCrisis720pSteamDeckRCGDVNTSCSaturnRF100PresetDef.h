/*
ShaderGlass preset retro-crisis/720p-Steam-Deck / RC GDV-NTSC - Saturn RF 100 imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis720pSteamDeckRCGDVNTSCSaturnRF100PresetDef : public PresetDef
{
public:
	RetroCrisis720pSteamDeckRCGDVNTSCSaturnRF100PresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - Saturn RF 100";
...
.Param("wrap_mode", "clamp_to_border"));
            OverrideParam("addnoised", (float)0.460000);
            OverrideParam("beam_max", (float)1.324995);
            OverrideParam("beam_min", (float)1.100000);
            ...
            OverrideParam("ntsc_scale", (float)0.950000);
