/*
ShaderGlass preset retro-crisis/1080p-Curved / RC GDV-NTSC - MSX - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1080pCurvedRCGDVNTSCMSXCleanPresetDef : public PresetDef
{
public:
	RetroCrisis1080pCurvedRCGDVNTSCMSXCleanPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - MSX - Clean";
