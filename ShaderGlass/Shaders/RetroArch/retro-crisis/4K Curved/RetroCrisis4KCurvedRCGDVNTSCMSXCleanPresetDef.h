/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - MSX - Clean imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCMSXCleanPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCMSXCleanPresetDef() : PresetDef{}
	{
