/*
ShaderGlass preset retro-crisis/4K-Curved / RC GDV-NTSC - MSX - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KCurvedRCGDVNTSCMSXDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KCurvedRCGDVNTSCMSXDirtyPresetDef() : PresetDef{}
	{
