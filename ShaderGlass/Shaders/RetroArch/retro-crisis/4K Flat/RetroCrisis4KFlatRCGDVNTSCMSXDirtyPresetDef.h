/*
ShaderGlass preset retro-crisis/4K-Flat / RC GDV-NTSC - MSX - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis4KFlatRCGDVNTSCMSXDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis4KFlatRCGDVNTSCMSXDirtyPresetDef() : PresetDef{}
	{
