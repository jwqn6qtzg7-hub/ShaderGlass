/*
ShaderGlass preset retro-crisis/1440p-Curved / RC GDV-NTSC - MSX - Dirty imported from RetroCrisis:
...
namespace RetroArch
{
class RetroCrisis1440pCurvedRCGDVNTSCMSXDirtyPresetDef : public PresetDef
{
public:
	RetroCrisis1440pCurvedRCGDVNTSCMSXDirtyPresetDef() : PresetDef{}
	{
		Name = "RC GDV-NTSC - MSX - Dirty";
...
.Param("wrap_mode", "clamp_to_border"));
            ...
            OverrideParam("beam_max", (float)1.624999);
            OverrideParam("beam_min", (float)0.800000);
            OverrideParam("bloom", (float)2.000000);
            OverrideParam("bloom_dist", (float)0.500000);
            OverrideParam("bsize1", (float)0.010000);
            OverrideParam("c_shape", (float)0.050000);
            OverrideParam("contr", (float)-0.100001);
            ...
            OverrideParam("wp_saturation", (float)0.900000);
	}
};
}
