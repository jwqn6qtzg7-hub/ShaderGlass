/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-Screen_SlotMask_Taller_Brightest imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/a4f3aeec04fcb2624ec6df5dd17e38f9b575eab9/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-Screen_SlotMask_Taller_Brightest.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMask_Taller_BrightestPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMask_Taller_BrightestPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Screen_SlotMask_Taller_Brightest";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("IN_GLOW_GAMMA", (float)2.220000);
            ...
            OverrideParam("PIXELGRID_Y_MASK_OFFSET_DEHIVE", (float)0.260000);
            ...
            OverrideParam("SATURATION", (float)1.100000);
