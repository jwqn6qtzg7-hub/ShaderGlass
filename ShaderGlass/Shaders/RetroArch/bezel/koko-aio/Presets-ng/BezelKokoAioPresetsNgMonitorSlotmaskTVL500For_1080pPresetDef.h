/*
ShaderGlass preset bezel/koko-aio / Monitor-slotmask-TVL500-for_1080p imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/a4f3aeec04fcb2624ec6df5dd17e38f9b575eab9/bezel/koko-aio/Presets-ng/Monitor-slotmask-TVL500-for_1080p.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorSlotmaskTVL500For_1080pPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorSlotmaskTVL500For_1080pPresetDef() : PresetDef{}
	{
		Name = "Monitor-slotmask-TVL500-for_1080p";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("HALO_POWER", (float)0.800000);
            ...
            OverrideParam("PIXELGRID_TVL_X", (float)500.000000);
