/*
ShaderGlass preset bezel/koko-aio / Monitor-crt-regale imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/a4f3aeec04fcb2624ec6df5dd17e38f9b575eab9/bezel/koko-aio/Presets-ng/Monitor-crt-regale.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorCrtRegalePresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorCrtRegalePresetDef() : PresetDef{}
	{
		Name = "Monitor-crt-regale";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BLOOM_HALATION_MIX", (float)0.800000);
            OverrideParam("BLOOM_MIX", (float)0.750000);
            OverrideParam("BLOOM_OVER_WHITE", (float)0.250000);
            OverrideParam("BLOOM_POWER", (float)0.500000);
            OverrideParam("BLOOM_QUALITY", (float)1.000000);
            OverrideParam("BLOOM_SIZE", (float)0.750000);
            OverrideParam("CONTRAST", (float)0.000000);
            ...
            OverrideParam("DO_PIXELGRID_H", (float)0.950000);
            OverrideParam("DO_PIXELGRID_W", (float)1.000000);
            ...
            OverrideParam("HALO_POWER", (float)0.900000);
            ...
            OverrideParam("IN_GLOW_POWER", (float)3.000000);
            ...
            OverrideParam("PIXELGRID_GAMMA_H", (float)5.399998);
            OverrideParam("PIXELGRID_GAMMA_W", (float)4.200000);
            OverrideParam("PIXELGRID_H_DEDOT", (float)0.000000);
            ...
            OverrideParam("PIXELGRID_Y_MASK", (float)0.550000);
            OverrideParam("PIXELGRID_Y_MASK_COORDS", (float)1.000000);
            OverrideParam("PIXELGRID_Y_MASK_HEIGHT", (float)-2.000000);
            OverrideParam("PIXELGRID_Y_MASK_OFFSET_DEHIVE", (float)0.230000);
            ...
            OverrideParam("SATURATION", (float)1.040000);
            ...
            OverrideParam("UNIFORMITY", (float)0.900000);
            OverrideParam("VIBRANCE", (float)0.000000);
