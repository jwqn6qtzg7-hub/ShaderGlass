/*
ShaderGlass preset bezel/koko-aio / Monitor-Screen_Hmask-Screen_SlotMask_Taller_MaxMask imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/25311dc03332d9ef2dff8d9d06c611d828028fac/bezel/koko-aio/Presets-ng/Monitor-Screen_Hmask-Screen_SlotMask_Taller_MaxMask.slangp
...
namespace RetroArch
{
class BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMask_Taller_MaxMaskPresetDef : public PresetDef
{
public:
	BezelKokoAioPresetsNgMonitorScreen_HmaskScreen_SlotMask_Taller_MaxMaskPresetDef() : PresetDef{}
	{
		Name = "Monitor-Screen_Hmask-Screen_SlotMask_Taller_MaxMask";
...
.Param("wrap_mode", "mirrored_repeat"));
            ...
            OverrideParam("BLOOM_GAMMA_OUT", (float)2.000000);
            ...
            OverrideParam("HALO_DO_MASK_HELPER", (float)1.000000);
            ...
            OverrideParam("HALO_POWER", (float)0.000000);
