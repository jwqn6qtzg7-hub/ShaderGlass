...
namespace RetroArch
{
class BezelUborderAppendUborderBezelReflectionsPresetDef : public PresetDef
{
public:
	BezelUborderAppendUborderBezelReflectionsPresetDef() : PresetDef{}
	{
		Name = "append-uborder-bezel-reflections";
		Category = "bezel/uborder";
	}

	virtual void Build() {
         	ShaderDefs.push_back(BezelUborderShadersUborderBezelReflectionsShaderDef()
