/*
ShaderGlass preset handheld/console-border / gbc-dmg imported from RetroArch:
https://github.com/libretro/slang-shaders/blob/a4f3aeec04fcb2624ec6df5dd17e38f9b575eab9/handheld/console-border/gbc-dmg.slangp
...
namespace RetroArch
{
class HandheldConsoleBorderGbcDmgPresetDef : public PresetDef
{
public:
	HandheldConsoleBorderGbcDmgPresetDef() : PresetDef{}
	{
		Name = "gbc-dmg";
